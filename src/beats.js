...
export const BEATS = [
  ...
  },
  {
    ...
    explode: 0, material: 'steel', handSpin: 3.7,
    kicker: '09 — Transition',
    title: 'Closing the loop',
    body: 'Thirty articulated rows leave the straight line and resolve into one continuous wearable arc.',
    specs: [['Open radius', '34.0'], ['Closed radius', '1.12'], ['Arc', '360°']],
    backdrop: 'CIRCLE',
  },
  {
